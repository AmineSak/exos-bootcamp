...
class Bugged_BinarySearch {
    ...
    static public int binarySearchHelper(int[] array,
        ...
        if (val == midVal) {
            ...
            return binarySearchHelper(array, val, start, midInt );
        } else {
            return binarySearchHelper(array, val, midInt+1 , end);
        }
    }
}